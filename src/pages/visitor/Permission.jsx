...
const mockPermissions = [
  {
    ...
    name: '陈梓涵',
    phone: '18653128801',
    visitTime: '2024-06-10 09:00',
    host: '王建国',
    dept: '技术部',
    status: '待下发',
    purpose: '技术交流',
    log: ['2024-06-09 审核通过', '2024-06-09 待下发'],
  },
  {
    key: '2',
    name: '李思远',
    phone: '18560091234',
    visitTime: '2024-06-11 14:30',
    host: '李明',
    dept: '行政部',
    status: '已下发',
    purpose: '商务洽谈',
    log: ['2024-06-10 审核通过', '2024-06-10 权限下发成功'],
  },
  {
    key: '3',
    name: '孙嘉禾',
    phone: '18753102345',
    visitTime: '2024-06-12 10:00',
    host: '赵云',
    dept: '管理层',
    status: '下发失败',
    purpose: '参观考察',
    log: ['2024-06-11 审核通过', '2024-06-11 权限下发失败'],
  },
  {
    key: '4',
    name: '王子睿',
    phone: '13969887732',
    visitTime: '2024-06-13 15:00',
    host: '孙倩',
    dept: '财务部',
    status: '已下发',
    purpose: '设备维护',
    log: ['2024-06-12 审核通过', '2024-06-12 权限下发成功'],
  },
  {
    key: '5',
    name: '赵一鸣',
    phone: '18853104567',
    visitTime: '2024-06-14 08:30',
    host: '陈梓涵',
    dept: '技术部',
    status: '待下发',
    purpose: '面试',
    log: ['2024-06-13 审核通过', '2024-06-13 待下发'],
  },
  {
    key: '6',
    name: '周子涵',
    phone: '18653109988',
    visitTime: '2024-06-15 13:00',
    host: '李思远',
    dept: '行政部',
    status: '已下发',
    purpose: '合作洽谈',
    log: ['2024-06-14 审核通过', '2024-06-14 权限下发成功'],
  },
  {
    key: '7',
    name: '钱宇航',
    phone: '18553107766',
    visitTime: '2024-06-16 09:30',
    host: '王子睿',
    dept: '管理层',
    status: '下发失败',
    purpose: '培训',
    log: ['2024-06-15 审核通过', '2024-06-15 权限下发失败'],
  },
  {
    key: '8',
    name: '吴雨桐',
    phone: '18753105544',
    visitTime: '2024-06-17 11:00',
    host: '孙嘉禾',
    dept: '财务部',
    status: '已下发',
    purpose: '签约仪式',
    log: ['2024-06-16 审核通过', '2024-06-16 权限下发成功'],
  },
  {
    key: '9',
    name: '郑浩然',
    phone: '18653102233',
    visitTime: '2024-06-18 10:30',
    host: '赵一鸣',
    dept: '技术部',
    status: '待下发',
    purpose: '设备调试',
    log: ['2024-06-17 审核通过', '2024-06-17 待下发'],
  },
  {
    key: '10',
    name: '冯思琪',
    phone: '18553104455',
    visitTime: '2024-06-19 16:00',
    host: '钱宇航',
    dept: '行政部',
    status: '已下发',
    purpose: '技术交流',
    log: ['2024-06-18 审核通过', '2024-06-18 权限下发成功'],
  },
];
