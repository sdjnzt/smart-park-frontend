...
// 最新动态
const news = [
  { title: '关于五一放假通知', type: '公告', time: '2025-05-01 09:00', tag: '已发布' },
  { title: '今日有2条告警待处理', type: '告警', time: '2025-05-10 10:20', tag: '待处理' },
  { title: '新员工入职培训', type: '公告', time: '2025-05-08 14:00', tag: '草稿' },
  { title: '会议室A101已被预约', type: '会议', time: '2025-05-10 09:00', tag: '已确认' },
];

// 最新动态详情Mock
const newsDetailMap = {
  '关于五一放假通知': '五一劳动节放假安排如下：5月1日至5月3日放假，共3天。请各部门提前做好工作安排。',
