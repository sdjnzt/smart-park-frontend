...
const mockDevices = [
  {
    ...
    status: 'online',
    type: '闸机',
    lastOp: '2024-06-01 09:12',
    manager: '王建国',
    health: '正常',
    firmware: 'v2.1.3',
    nextMaintain: '2024-07-01',
    logs: [
      { time: '2024-06-01 09:12', action: '远程开门', user: '管理员' },
      { time: '2024-05-30 15:00', action: '固件升级', user: '技术员' },
    ],
  },
  {
    key: '2',
    ...
    status: 'offline',
    type: '门禁',
    lastOp: '2024-05-31 18:22',
    manager: '李明',
    health: '故障',
    firmware: 'v2.0.9',
    nextMaintain: '2024-06-10',
    logs: [
      { time: '2024-05-31 18:22', action: '设备离线', user: '系统' },
      { time: '2024-05-20 10:00', action: '维护保养', user: '李明' },
    ],
  },
  {
    key: '3',
    ...
    status: 'online',
    type: '闸机',
    lastOp: '2024-06-01 08:45',
    manager: '赵云',
    health: '正常',
    firmware: 'v2.1.3',
    nextMaintain: '2024-08-01',
    logs: [
      { time: '2024-06-01 08:45', action: '远程关门', user: '管理员' },
      { time: '2024-05-15 09:00', action: '维护保养', user: '赵云' },
    ],
  },
  {
    key: '4',
    ...
    status: 'online',
    type: '门禁',
    lastOp: '2024-06-01 10:00',
    manager: '孙倩',
    health: '正常',
    firmware: 'v2.2.0',
    nextMaintain: '2024-07-15',
    logs: [
      { time: '2024-06-01 10:00', action: '远程开门', user: '管理员' },
      { time: '2024-05-10 14:00', action: '固件升级', user: '技术员' },
    ],
  },
];
