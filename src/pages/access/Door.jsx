...
const mockDevices = [
  {
    ...
    status: 'online',
    type: '闸机',
    lastOp: '2025-05-01 09:12',
    manager: '王建国',
    health: '正常',
    firmware: 'v2.1.3',
    nextMaintain: '2025-07-01',
    logs: [
      { time: '2025-05-01 09:12', action: '远程开门', user: '管理员' },
  ...
  },
  {
    ...
    status: 'online',
    type: '闸机',
    lastOp: '2025-05-01 08:45',
    manager: '赵云',
    health: '正常',
    firmware: 'v2.1.3',
    nextMaintain: '2025-08-01',
    logs: [
      { time: '2025-05-01 08:45', action: '远程关门', user: '管理员' },
  ...
  },
  {
    ...
    status: 'online',
    type: '门禁',
    lastOp: '2025-05-01 10:00',
    manager: '孙倩',
    health: '正常',
    firmware: 'v2.2.0',
    nextMaintain: '2025-07-15',
    logs: [
      { time: '2025-05-01 10:00', action: '远程开门', user: '管理员' },
  ...
  },
  {
    ...
    status: 'online',
    type: '闸机',
    lastOp: '2025-05-02 11:00',
    manager: '陈梓涵',
    health: '正常',
    firmware: 'v2.2.1',
    nextMaintain: '2025-08-01',
    logs: [
      { time: '2025-05-02 11:00', action: '远程开门', user: '管理员' },
      { time: '2025-05-01 10:00', action: '维护保养', user: '陈梓涵' },
    ],
  },
  {
    key: '6',
  ...
  },
  {
    ...
    status: 'online',
    type: '闸机',
    lastOp: '2025-05-03 08:20',
    manager: '孙嘉禾',
    health: '正常',
    firmware: 'v2.1.5',
    nextMaintain: '2025-09-01',
    logs: [
      { time: '2025-05-03 08:20', action: '远程开门', user: '管理员' },
      { time: '2025-05-01 10:00', action: '维护保养', user: '孙嘉禾' },
    ],
  },
  {
    key: '8',
    ...
    status: 'online',
    type: '门禁',
    lastOp: '2025-05-04 09:40',
    manager: '王子睿',
    health: '正常',
    firmware: 'v2.2.2',
    nextMaintain: '2025-10-01',
    logs: [
      { time: '2025-05-04 09:40', action: '远程开门', user: '管理员' },
  ...
  },
  {
    ...
    status: 'online',
    type: '门禁',
    lastOp: '2025-05-05 10:30',
    manager: '许思辰',
    health: '正常',
    firmware: 'v2.2.3',
    nextMaintain: '2025-12-01',
    logs: [
      { time: '2025-05-05 10:30', action: '远程开门', user: '管理员' },
      { time: '2025-05-01 10:00', action: '维护保养', user: '许思辰' },
    ],
  },
  {
    key: '11',
    ...
    status: 'online',
    type: '闸机',
    lastOp: '2025-05-06 11:15',
    manager: '罗一帆',
    health: '正常',
    firmware: 'v2.1.6',
    nextMaintain: '2026-01-01',
    logs: [
      { time: '2025-05-06 11:15', action: '远程开门', user: '管理员' },
      { time: '2025-05-01 10:00', action: '维护保养', user: '罗一帆' },
    ],
  },
  {
    key: '12',
    ...
    logs: [
      ...
      { time: '2025-05-01 09:00', action: '维护保养', user: '贾嘉懿' },
    ],
  },
];
