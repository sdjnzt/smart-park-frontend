...
const mockCameras = [
  { key: '1', name: '1号楼北门摄像头', code: 'CAM-001', location: '1号楼北门', group: '1号楼', status: '在线', type: '枪机', lastOnline: '2024-06-01 09:00', install: '2022-03-01', manager: '王建国', logs: [{ time: '2024-05-30', action: '固件升级', user: '管理员' }] },
  ...
  { key: '3', name: '3号楼西门枪机', code: 'CAM-003', location: '3号楼西门', group: '3号楼', status: '在线', type: '枪机', lastOnline: '2024-06-01 08:50', install: '2022-05-10', manager: '赵云', logs: [{ time: '2024-05-10', action: '固件升级', user: '管理员' }] },
  { key: '4', name: '1号楼大厅球机', code: 'CAM-004', location: '1号楼大厅', group: '1号楼', status: '在线', type: '球机', lastOnline: '2024-06-01 09:10', install: '2022-03-05', manager: '王建国', logs: [{ time: '2024-05-28', action: '维护保养', user: '王建国' }] },
  { key: '5', name: '2号楼停车场枪机', code: 'CAM-005', location: '2号楼停车场', group: '2号楼', status: '在线', type: '枪机', lastOnline: '2024-06-01 09:12', install: '2022-04-20', manager: '李明', logs: [{ time: '2024-05-25', action: '固件升级', user: '管理员' }] },
  ...
  { key: '7', name: '1号楼电梯间枪机', code: 'CAM-007', location: '1号楼电梯间', group: '1号楼', status: '在线', type: '枪机', lastOnline: '2024-06-01 09:15', install: '2022-03-10', manager: '王建国', logs: [{ time: '2024-05-29', action: '固件升级', user: '管理员' }] },
  { key: '8', name: '2号楼大堂球机', code: 'CAM-008', location: '2号楼大堂', group: '2号楼', status: '在线', type: '球机', lastOnline: '2024-06-01 09:18', install: '2022-04-25', manager: '李明', logs: [{ time: '2024-05-27', action: '维护保养', user: '李明' }] },
  { key: '9', name: '3号楼地下室枪机', code: 'CAM-009', location: '3号楼地下室', group: '3号楼', status: '在线', type: '枪机', lastOnline: '2024-06-01 09:20', install: '2022-05-25', manager: '赵云', logs: [{ time: '2024-05-22', action: '固件升级', user: '管理员' }] },
